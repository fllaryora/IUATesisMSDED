...
void advancePhaseFunction(int * inputWorktask, int* outPutWorktask, const Function *initialStatus, const MPI_Comm commNodes, const int mpiProcesses,const int isPrima){ 
