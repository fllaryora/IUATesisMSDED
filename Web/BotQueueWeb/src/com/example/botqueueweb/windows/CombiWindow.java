...
public class CombiWindow extends Window {
	...
	public CombiWindow(final DBObject combi,DBObject dbProbBranch, final AppletIntegration applet, boolean isFull, Project project) {
        ...
        if (combi.get("delay")!=null)
        {
        	...
        	else if (((BasicDBObject)combi.get("delay")).get("distribution").toString().equalsIgnoreCase("log-normal"))
