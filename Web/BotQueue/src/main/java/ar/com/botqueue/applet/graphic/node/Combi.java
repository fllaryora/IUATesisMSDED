...
public class Combi extends GenericNode{
	private static final int COMBI_ORDER = 0;
	private static final int COMBI_HEIGHT = 45;
	private static final int COMBI_WIDTH = 70;
	...
	public Combi(int posX, int posY, String label) {
		...
		super(posX, posY, label, COMBI_WIDTH, COMBI_HEIGHT, COMBI_ORDER);
	...
	public Combi(int posX, int posY, String label, boolean probBranch, String distribution, int seed,
			double least, double highest, double constant, double mean,
			double variance, double lambda, double mode, double minimun,
			double maximun, double shapeAlpha, double shapeBeta, double shape,
			double escale) {
		super(posX, posY, label, COMBI_WIDTH, COMBI_HEIGHT, COMBI_ORDER);
	...
	public void editCombi(String distribution, int seed, double least, double highest, double constant,
